...
if(todoss[index].completed){
    console.log(`${todoss[index].todo} is completed`)
}else{
    console.log(`${todoss[index].todo} is pending`)
}
}
...
//     console.log(` ${products[index].title} price is ${products[index].price}`);
//     if (products[index].discountPercentage > 10) {
//       console.log("Heavy Discount on this item");
//     }
//   }
